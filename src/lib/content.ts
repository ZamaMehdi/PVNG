...
export const content: { en: Content; ar: Content } = {
  en: {
    ...
    officeAddress: 'Abraj Center<br />Office no. 904<br />Naif, Makani no 29182-95894',
    ...
    contactAddressLine1: 'Abraj Center',
    contactAddressLine2: 'Office no. 904',
    contactAddressLine3: 'Naif, Makani no 29182-95894',
    contactAddressLine4: 'P.O. Box 99141 DXB',
    ...
    contactVisitLocationDesc: 'Located in Naif, Dubai for easy access and convenience.',
  ...
  ar: {
    ...
    contactVisitLocationDesc: 'يقع في نايف، دبي لسهولة الوصول والراحة',
