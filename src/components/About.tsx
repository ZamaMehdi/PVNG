                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3 flex-row-reverse">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm md:text-base text-gray-600 leading-relaxed">{langContent.sustainabilityDesc}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="fade-in">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.cfAPMP}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.iso14001EMS}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.carbonReductionPlanSpecialist}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.bidSpecialistUK}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start relative z-10">
                ...
                <div className="fade-in">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.electromechanicalSystems}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.firefightingSystems}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.gasPipelineWorks}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.lowVoltageSystems}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.securitySystems}</div>
                      <div className="text-sm text-gray-900 font-medium bg-gray-100 px-3 py-2 rounded-md">{langContent.maintenanceService}</div>
                    </div>
                  </div>
                </div>
              </div>
