...
export default function FloatingChatButton() {
  ...
  return (
    <>
      ...
      {!isMobile && (
        <>
          ...
          <a
            ...
            aria-label="Call Us"
          >
            <svg className="w-6 h-6 sm:w-8 sm:h-8 text-white group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Mobile: WhatsApp Always Visible + Collapsible Menu (< 500px) */}
      {isMobile && (
        <>
          ...
          {/* Collapsible Menu for Other Buttons */}
            ...
            {isExpanded && (
              <div className="absolute bottom-16 right-0 space-y-3 mb-2">
                ...
                <button
                  ...
                  className="bg-blue-500 text-white p-2 rounded-full shadow-lg hover:shadow-xl hover:bg-blue-600 transition-all duration-200 group"
                  aria-label="Open Chat"
                >
                  <svg className="w-5 h-5 text-white group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h4l4 4 4-4h4c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"/>
                ...
                >
                  ...
                  <svg 
                    className="w-14 h-12 text-gray-700 group-hover:scale-110 transition-transform duration-200" 
                    style={{ display: 'none' }}
                    fill="currentColor" 
                    viewBox="0 0 24 24"
                  >
